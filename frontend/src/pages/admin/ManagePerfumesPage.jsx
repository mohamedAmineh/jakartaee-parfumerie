  ...
  return (
    <div className="admin-manage">
      <style>{`
        ...
        .admin-manage__layout {
          display: grid;
          grid-template-columns: 2fr 1fr;
          gap: 20px;
        }
        @media (max-width: 1024px) {
          .admin-manage__layout { grid-template-columns: 1fr; }
        }
        ...
        .admin-manage__row:hover {
          box-shadow: 0 12px 22px rgba(25,15,10,0.08);
        }
        .admin-manage__row--active {
        ...
        .admin-manage__status { color: #1c1916; font-weight: 700; }
      ...
      <div className="admin-manage__wrap">
        ...
        <div className="admin-manage__card" style={{ marginBottom: "16px" }}>
